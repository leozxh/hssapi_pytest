...
def run_tests():
    ...
    CONFIG = {
        ...
        "allure_html_report_dir": "html_reports"
    }
    project_root = CONFIG["project_root"]
    test_dir = os.path.join(project_root, CONFIG["test_dir"])
    allure_report_dir = os.path.join(project_root, CONFIG["allure_report_dir"])
    allure_html_report_dir = os.path.join(project_root, CONFIG["allure_html_report_dir"])
